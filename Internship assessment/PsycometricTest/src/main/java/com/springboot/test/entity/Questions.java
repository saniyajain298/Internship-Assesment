...
public class Questions {
	...
	public Questions(int questionId, String question, String answer, String option1, String option2, String option3,
			String option4) {
		super();
	...
	public String toString() {
		return "Question [questionId=" + questionid + ", question=" + question + ", answer=" + answer + ", option1="
